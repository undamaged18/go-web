...
func Parse(userAgent string) UserAgent {
	...
	case tokens.exists("DuckDuckBot"):
		ua.Name = DuckDuckBot
		ua.Version = tokens[DuckDuckBot]
		ua.Bot = true
		ua.Mobile = tokens.existsAny("Mobile", "Mobile Safari")
...
func (ua UserAgent) IsBingBot() bool {
	return ua.Name == BingBot
}

func (ua UserAgent) IsAppleBot() bool {
	return ua.Name == Applebot
}

func (ua UserAgent) IsSlurpBot() bool {
	return ua.Name == SlurpBot
}

func (ua UserAgent) IsDuckDuckBot() bool {
	return ua.Name == DuckDuckBot
}
